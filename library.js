...
const validateForm = () => {
  if (title.validity.valueMissing) {
    title.setCustomValidity("Please include the title of the book");
  ...
  if (author.validity.valueMissing) {
    author.setCustomValidity("Please include the author of the book");
  ...
  if (pages.validity.valueMissing) {
    ...
    pages.setCustomValidity("Enter a positive number");
    pages.reportValidity();
    return false;
  } else {
